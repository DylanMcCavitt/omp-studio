      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-1 font-mono text-xs text-ink-faint">
            <span className="min-w-0 max-w-full truncate text-ink-muted sm:max-w-[10rem]"
    ...
    return (
      <div className="rounded-lg border border-danger/30 bg-danger/5 px-3 py-2">
        <div className="flex items-start justify-between gap-2">
          <span className="block min-w-0 flex-1 truncate text-sm font-medium text-ink"
            title={title}>
            {title}
          </span>
          <Badge variant="danger">Resume failed</Badge>
        </div>
        <p className="mt-1 line-clamp-2 break-words text-xs text-ink-muted [overflow-wrap:anywhere]" title={error}>
          {error}
        </p>
    ...
    <div className="group relative">
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="mt-0.5 block max-w-full truncate font-mono text-xs text-ink-faint"
